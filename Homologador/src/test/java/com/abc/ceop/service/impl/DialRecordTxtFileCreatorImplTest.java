...
public class DialRecordTxtFileCreatorImplTest {

	@Resource
	private DialRecordTxtFileCreator dialRecordTxtFileCreator;
	@Resource
	...
	@Test
	public void testWriteTxtFile_false() {
		SecondProcessCommonData cd = loadSecondProcessCommonData();
		String filepath = dialRecordTxtFileCreator.createFile(cd, false);
		Assert.assertTrue(filepath.contains("userReplies"));
	}
	
	@Test
	public void testWriteTxtFile_true() {
		SecondProcessCommonData cd = loadSecondProcessCommonData();
		String filepath = dialRecordTxtFileCreator.createFile(cd, true);
		Assert.assertTrue(filepath.contains("userReplies"));
	}
